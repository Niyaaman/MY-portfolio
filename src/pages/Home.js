...
import my_Prorfile from '../assets/my_photo.jpeg';

export default function Home() {
  return (
    <div className='flex justify-center items-center flex-col h-screen  text-4xl transform translate-y-20 py-12 ' id='home'>
      <div className='border-4 border-blue-900 rounded-full'>
        <img src={my_Prorfile} alt='profile' className='rounded-full w-40 h-40  shadow-[5px_5px_25px_rgba(45,212,191,0.45),_-5px_-5px_25px_rgba(16,185,129,0.35)]' />
      </div>
      ...
      <div className='flex space-x-7 pt-11 h-40 w-100  min-[200px]:flex-col sm:flex-col lg:flex-row justify-center items-center '> 
        ...
        <div className=' hover:bg-[#25D366] w-60 h-20 border-solid rounded-full border-2 border-bg-primary text-2xl flex justify-center items-center shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer  '> 
          ...
          viewBox="0 0 24 24" 
          fill="currentColor" 
          className="w-8 h-8" /* 👈 Controls size (32px by 32px) */
        >
